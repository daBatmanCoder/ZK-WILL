...
(async () => {
	...
	const { root, pathElements, pathIndices } = await calculateMerkleRootAndPath(mimc, levels, commitments, "2993567471794227429412840266475057253900418219209110714020724241671133659637");
...
async function calculateMerkleRootAndPath(mimc, levels, elements, element) {
    ...
    return {
        root: root.toString(),
        pathElements: pathElements.map(e => '0x' + BigInt(commitment).toString(16)),
