...
(async () => {
	...
	const commitment = await calculateInputToProof(mimc, levels, commitments, nullifier, secret);
	const { root, pathElements, pathIndices } = await calculateMerkleRootAndPath(mimc, levels, commitments, );
