...
(async () => {
	...
	const { root, pathElementsRaw, pathIndicesRaw } = calculateMerkleRootAndPath(mimc, levels, commitments, "2993567471794227429412840266475057253900418219209110714020724241671133659637");
...
function calculateMerkleRootAndPath(mimc, levels, elements, element) {
    ...
    if (element) {
        ...
        const bne = Web3.BigNumber.from(element);
        let index = layers[0].findIndex(e => Web3.BigNumber.from(e).eq(bne));
