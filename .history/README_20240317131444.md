...
First we need to generate the nullifier and a secret, hash them together using MiMCSponge hashing algo' - the choice for that algo' is because it's fast with zk-proofs, reliable and cheap.
