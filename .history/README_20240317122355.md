...
- `_hasher` is the address of the MiMC sponge smart contract. * in order to generate this contract you'll have to use hardhat and circomlibjs library. - (more about it in the future)
