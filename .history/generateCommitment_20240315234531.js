...
(async () => {
	...
	const { root, pathElements, pathIndices } = calculateMerkleRootAndPath(mimc, levels, commitments, "2993567471794227429412840266475057253900418219209110714020724241671133659637");
